...
export default function B2BContact() {
  ...
  return (
    <>
      ...
      <section id="contact" className="hidden lg:flex fullscreen-section bg-[#F8FAFC] text-[#142033] relative overflow-hidden border-b border-clarion-line/60">
        <div className="container-main max-w-7xl lg:max-w-[1320px] relative z-10 space-y-4 sm:space-y-5 lg:space-y-6 pt-16 sm:pt-12 lg:pt-[72px] pb-6 lg:pb-8 my-auto">
      ...
      {/* MOBILE SLIDE 1 (#contact) — B2B CONSULTATION INTRO & DOMAINS (lg:hidden) */}
      <section id="contact" className="lg:hidden fullscreen-section bg-[#F8FAFC] text-[#142033] border-b border-clarion-line/60">
        <div className="container-main max-w-7xl h-full flex flex-col justify-between py-4 text-left">
          ...
          <div className="space-y-1.5">
            <h2 className="text-xl font-extrabold text-[#142033] leading-tight tracking-tight">
              복잡한 요구를,<br />
              <span className="text-[#1265E5]">명확한 실행으로 연결합니다.</span>
            </h2>
            <p className="text-xs text-[#334155] leading-relaxed">
              프로젝트의 목적과 상황을 남겨주시면, 최적의 실행 방향을 안내해 드립니다.
            </p>
          </div>

          {/* 4 Inquiry Domains List */}
          <div className="space-y-1.5 my-auto py-1 font-mono text-xs">
            <span className="text-[10px] font-bold text-clarion-muted uppercase tracking-wider block">INQUIRY DOMAINS</span>
            <div className="p-2 bg-white rounded border border-clarion-line/60 flex items-center justify-between">
              <span className="font-bold text-[#142033]">01 Enterprise IT / SI</span>
              <span className="text-[10px] text-clarion-muted">코어/클라우드</span>
            </div>
            <div className="p-2 bg-white rounded border border-clarion-line/60 flex items-center justify-between">
              <span className="font-bold text-[#142033]">02 AI / Data</span>
              <span className="text-[10px] text-clarion-muted">지능화 파이프라인</span>
            </div>
            <div className="p-2 bg-white rounded border border-clarion-line/60 flex items-center justify-between">
              <span className="font-bold text-[#142033]">03 Healthcare AI</span>
              <span className="text-[10px] text-clarion-muted">한생AI 웰니스</span>
            </div>
            <div className="p-2 bg-white rounded border border-clarion-line/60 flex items-center justify-between">
              <span className="font-bold text-[#142033]">04 Tech R&D</span>
              <span className="text-[10px] text-clarion-muted">특허/기술협력</span>
            </div>
          </div>

          {/* Bottom Button to Form */}
          <div className="pt-2">
            <a
              href="#contact-form"
              className="w-full py-3 bg-[#1265E5] text-white font-extrabold text-xs rounded-xl flex items-center justify-center gap-1.5 shadow-md"
            >
              <span>온라인 문의서 작성하기 ➔</span>
            </a>
          </div>
        </div>
      </section>

      {/* MOBILE SLIDE 2 (#contact-form) — FULL B2B FORM WITH ALLOW-OVERFLOW (lg:hidden) */}
      <section id="contact-form" className="lg:hidden fullscreen-section allow-overflow bg-white text-[#142033] border-b border-clarion-line/60 py-6">
        <div className="container-main max-w-7xl">
          <div className="bg-white rounded-xl p-4 border border-clarion-line/70 shadow-xs">
            {renderFormContent()}
          </div>
        </div>
      </section>
