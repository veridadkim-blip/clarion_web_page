...
const growthDomains = [
  {
    ...
    sub: '실무형 AI 모델 결합',
    desc: '금융·보험 및 기업 현장 프로세스 위에 맞춤형 AI 예측 모델 및 자동 분석 알고리즘을 연동합니다.',
    icon: Cpu,
  },
  {
    id: 'data',
    ...
    sub: '실시간 파이프라인 수집',
    desc: '분산된 이종 데이터 소스를 실시간 파이프라인으로 수집·가공하여 명확한 비즈니스 파이프라인을 수립합니다.',
    icon: Database,
  },
  {
    id: 'platform',
    ...
    sub: '자동화 및 플랫폼화',
    desc: '반복적인 인프라 업무 및 리포팅 절차를 자동화하고 지속 가능한 서브스크립션 플랫폼으로 고도화합니다.',
    icon: Network,
  },
  {
    id: 'govtech',
    title: 'GovTech',
    sub: '공공·특수 플랫폼 연구',
    desc: '공공기관 및 특수 산업 분야의 고도의 보안 컴플라이언스와 데이터 접근 통제에 적합한 디지털 표준 연구',
    icon: Building,
  },
]

const rndProcessSteps = [
  { step: '01', title: '현장 요구 발굴', desc: '금융·기업 현장의 페인포인트 수집' },
  { step: '02', title: '기술과제 정의', desc: '핵심 AI·Data 문제 구조화' },
  { step: '03', title: '내부 R&D', desc: '자체 알고리즘 및 엔진 연구' },
  { step: '04', title: '특허·기술자산', desc: '지식재산권 확보 및 기술 자산화' },
  { step: '05', title: '고객 적용', desc: '엔터프라이즈 환경에 검증 적용' },
  { step: '06', title: '플랫폼화', desc: '지속 가능한 SaaS/플랫폼 전개' },
]
...
export default function GrowthTechnology() {
  ...
  return (
    <section id="growth-technology" className="py-20 lg:py-28 bg-gradient-to-b from-[#07152B] via-[#0B1F3A] to-[#050D1A] text-white relative overflow-hidden border-b border-white/10">
      {/* Subtle Animated Data Line Canvas SVG Overlay */}
      <div className="absolute inset-0 pointer-events-none opacity-25">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle cx="950" cy="400" r="3" fill="#37B7FF" className="animate-ping" style={{ animationDuration: '4s' }} />
        </svg>
      </div>
      ...
      <div className="container-main relative z-10 space-y-16">
        ...
        <div className="max-w-3xl space-y-4">
          <span className="inline-block px-3.5 py-1 bg-[#37B7FF]/15 text-[#37B7FF] font-mono font-bold text-xs tracking-wider uppercase rounded-full border border-[#37B7FF]/30">
            GROWTH TECHNOLOGY · AI DATA SPACE
          </span>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight">
            From Data to Action.
          </h2>
          <p className="text-base sm:text-lg text-white/80 font-normal leading-relaxed max-w-2xl">
            현장의 경험을 자체 기술로. 분산된 이종 데이터 소스가 AI CORE를 통과하여 명확한 Insight와 실질적인 실행(Action)으로 가치 변환됩니다.
          </p>
        </div>

        {/* Primary Interactive Intelligence Visual Diagram (DATA/SYSTEM/CLOUD -> CONTEXT -> AI CORE -> INTELLIGENCE -> ACTION) */}
        <div className="bg-[#0B1F3A]/90 p-8 lg:p-12 rounded-3xl border border-white/20 shadow-2xl space-y-10">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/15 pb-5">
            <div>
              <span className="text-xs font-mono font-bold text-[#37B7FF] uppercase tracking-wider">INTELLIGENCE DATA FLOW</span>
              <h3 className="text-xl sm:text-2xl font-bold text-white">DATA → CONTEXT → INTELLIGENCE → ACTION</h3>
            </div>
            <div className="flex items-center gap-2 text-xs font-mono text-[#37B7FF] bg-white/10 px-3.5 py-1.5 rounded-lg border border-white/15">
              ...
              <span>CLARION AI CORE ENGINE</span>
            </div>
          </div>

          {/* Interactive Visual Flow Stage */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
            {/* Step 1: DATA SOURCE */}
            <div className="bg-white/5 p-5 rounded-2xl border border-white/15 space-y-2 text-center">
              <span className="text-[10px] font-mono text-[#37B7FF] font-extrabold uppercase">01 SOURCE</span>
              <h4 className="text-sm font-bold text-white">DATA / SYSTEM / CLOUD</h4>
              <p className="text-[11px] text-white/70">이종 업무 수집 파이프라인</p>
            </div>

            {/* Step 2: CONTEXT */}
            <div className="bg-white/10 p-5 rounded-2xl border border-white/15 space-y-2 text-center">
              <span className="text-[10px] font-mono text-[#37B7FF] font-extrabold uppercase">02 CONTEXT</span>
              <h4 className="text-sm font-bold text-white">CONTEXT</h4>
              <p className="text-[11px] text-white/70">비즈니스 맥락 구조화</p>
            </div>

            {/* Step 3: AI CORE INTELLIGENCE */}
            <div className="bg-[#1265E5] p-6 rounded-2xl border border-blue-400/40 space-y-2 text-center shadow-lg shadow-blue-600/40 relative">
              ...
              <span className="text-[10px] font-mono text-white font-extrabold uppercase">03 INTELLIGENCE</span>
              <h4 className="text-base font-extrabold text-white">CLARION AI CORE</h4>
              <p className="text-[11px] text-white/90">자체 지능형 추론 엔진</p>
            </div>
            ...
            <div className="bg-[#37B7FF]/20 p-5 rounded-2xl border border-[#37B7FF]/40 space-y-2 text-center">
              ...
              <p className="text-[11px] text-[#37B7FF]">기업의 명확한 실행</p>
            </div>
          </div>

          {/* 4 Tech Domains Selector */}
            ...
            {growthDomains.map((domain) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <h4 className="text-sm sm:text-base font-bold text-white">{domain.title}</h4>
                    <p className="text-[11px] text-white/70 font-medium pt-0.5">{domain.sub}</p>
                  </div>
                </button>
              )
            })}
